# R2 求职与学习三阶段总纲（2026-09-02 定稿；2026-09-07 刷新）

> 状态：阶段总纲定稿（2026-09-02，09-07 刷新：§4.3 增低物精修收手行）；执行细节一律引用既有文档，本文件只做排期与接口（单一事实来源，
...
- **低物感知机制精修 —— 09-07 用户定收手**：物理边界（0.35m 箱 1.59m 临界 ring 律）+ 结构性冲突（global 清空抹保留 mark、盲区不可再生）双实锤 → 不再投实车/VM 窗口；测试场景维持高箱规避（§4.1 前置③）；降额版 mark-only 结构（180077c）保留不回滚；主线 3D 规控方向按 §4.1/§5.1 既有排期 — [决策 09-07](../retrospect/2026-09-07_lowobstacle_pivot_decision.md)
- 新功能 / 新项目 / 系统学习新体系
