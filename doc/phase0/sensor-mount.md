...
| 项目 | 值 | 说明 |
|:-----|:---|:-----|
| 安装位置 | **(-36, -3.5, +18.5) cm**（base_link 系） | ✅ 08-24 实车量测（钢卷尺）：距地 30~31cm − base_link 12cm = 18.5cm；静态 TF 当前为单位变换，平移待补齐（FAST-LIO 外参已用此实测值，见 [fastlio2-n97-deploy.md](../fastlio2-n97-deploy.md) §三.1） |
