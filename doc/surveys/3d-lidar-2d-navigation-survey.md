...
> L1-L4 分层认知见 §三B）→ **09-07 收手注记**：修法 B 实车第一次接近有效，但二次失效根因实锤 =
> 盲区保留 mark 被 global 整层清空事件一票抹除且不可再生（结构性冲突）→ **09-07 用户决策：
> 低物机制精修收手，主线转 3D 规控**，本清单手段方向存留作阶段二+/加传感器时参考 —
> [决策 09-07](../retrospect/2026-09-07_lowobstacle_pivot_decision.md)、
