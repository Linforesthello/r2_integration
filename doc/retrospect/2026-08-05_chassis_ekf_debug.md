...
>
> **⚠️ 历史陈述校准（2026-09-16 补注，原文保留）**：以上"进行中 / 未提交 git"为**当日现场状态**，早已不成立——
> ① 本文已提交入库；② §三 续传步骤 1~5 均已走完：底盘里程计修复（omega 单位 + 全向积分）**已实车验证**
> （[02-progress.md](../02-progress.md) 记 08-06 ✅；公式落 [chassis_definition.md](../phase0/chassis_definition.md)），
> z 漂移由 [08-09 档](2026-08-09_ekf_z_drift_fix.md) 接手修复（two_d_mode）。
> 按 [doc-engineering §十](../doc-engineering.md)「翻案留痕」口径处理：原文不动，此处加注。
